...
public sealed class IdentityServiceTests
{
    ...
    public async Task SignInAsync_ShouldReturnJwtDto_WhenCredentialsAreValid()
    {
        ...
        await _tokenManager.Received(1).CreateTokenAsync(user.Id.ToString(), user.Email, user.Role, claims: user.Claims);
    }
    ...
    public async Task SignInAsync_ShouldThrowInvalidCredentialsException_WhenUserDoesNotExist()
    {
        ...
        await _tokenManager.DidNotReceive().CreateTokenAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(),
    ...
    public async Task RefreshTokenAsync_ShouldReturnNewJwt_WhenValidRefreshTokenProvided()
    {
        ...
        var user = new User { Id = userId, IsActive = true, Email = "john.doe@test.com", Role = "Student", Claims = [] };
