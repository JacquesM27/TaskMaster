...
namespace TaskMaster.Modules.Accounts.Tests.Unit.Services;
...
public class TokenManagerTests
{
    ...
    {
        _authSettings = Substitute.For<IOptions<AuthSettings>>();
        _timeProvider = new FakeTimeProvider();
        _timeProvider.SetUtcNow(new DateTimeOffset(new DateTime(2024, 9, 2)));
        _authSettings.Value.Returns(new AuthSettings
        {
            Issuer = "TaskMaster",
        ...
        _tokenManager = new TokenManager(_authSettings, _timeProvider, _refreshTokenService);
    }
    ...
    public void Constructor_ShouldThrowException_WhenIssuerSigningKeyIsNotSet()
    {
        ...
        Should.Throw<InvalidOperationException>(() =>
            new TokenManager(_authSettings, _timeProvider, _refreshTokenService));
    }
    ...
    public void GenerateActivationToken_ShouldReturnValidToken_WithCorrectExpiry()
    {
        ...
        var expectedExpiry = _timeProvider.GetLocalNow().Add(_authSettings.Value.ActivationExpiry)
